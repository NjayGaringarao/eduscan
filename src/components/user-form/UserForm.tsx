...
const UserForm = ({
    ...
    return (
      <div key="personal_info_form" className="w-full flex flex-col gap-4">
        ...
        <p className="pl-6 text-base text-primary/90 -mt-2">
          Please enter the user's personal information accurately. This will be
          used for user identification and records.
        </p>
        <div className="pl-2 md:pl-6 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col">
            <RadioGroup
              ...
              setValue={(e) => setPersonalForm((prev) => ({ ...prev, sex: e }))}
        ...
        <div className="pl-2 md:pl-6 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col">
            <RadioGroup
              ...
              setValue={(e) => setGuardianForm((prev) => ({ ...prev, sex: e }))}
              className="flex flex-row"
            ...
            >
              {["MALE", "FEMALE"].map((s) => (
                <div key={s} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`guardian_sex-${s.toLowerCase()}`}>{s}</label>
                </div>
              ))}
            </RadioGroup>
  ...
  return (
    ...
    >
      ...
      {organizationalForm.user_type === "STUDENT" && guardianInformationForm()}
      {faceEncodingForm()}
    </div>
  );
};
