        ...
        <div className="flex flex-col gap-2">
          <div className="flex-1 flex flex-row gap-2 justify-between items-center">
            <div className="flex gap-2">
              <Button
                className={`min-w-24 px-2 py-1 ${view === "attendance" ? "bg-primary text-background" : "bg-background text-primary"}`}
              ...
              <Button
                className={`min-w-24 px-2 py-1 ${view === "dtr" ? "bg-primary text-background" : "bg-background text-primary"}`}
                onClick={() => setView("dtr")}
                secondary
              >
                DTR
            ...
            <div className="flex gap-2">
              {view === "attendance" ? (
                ...
                <Button
                  ...
                  disabled={isDtrLoading || isDtrDownloading || !dtr || dtr.rows.length === 0}
                  secondary
                >
                  <Download />
                  Download DTR
